...
Цей репозиторій містить розв’язки задач із [Проєкту Ейлера](https://projecteuler.net/about) — онлайн-ресурсу для розвитку алгоритмічного мислення та навичок програмування через розв’язання цікавих математичних задач.
Проєкт ідеально підходить для практики в Python, C++, Java або будь-якій іншій мові програмування.
