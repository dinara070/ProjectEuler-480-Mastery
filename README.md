...
| **243**  | 📉 **Фракції з відносно простими елементами**        | Задача вимагає розуміння функції Ейлера, оцінки частки сприятливих дробів — ідеальне поєднання ймовірності та теорії чисел.                                                                                          |
| **345**  | 🧠 **Максимальний прибуток при призначенні**         | Прототип задачі про пошук оптимального парування у матриці — потребує застосування алгоритму Хангара або динамічного програмування. Практичне застосування — розподіл ресурсів.                                      |
| **127**  | 🔺 **abc-triples: Радикали та співвідношення**       | Дуже складна задача на тему рідкісного abc-здогаду. Вимагає нестандартного мислення, оптимізації, ефективного обходу.                                                                                                |
| **148**  | 🔢 **Біноміальні коефіцієнти по модулю**             | Використання принципів Люка для обчислення біноміальних коефіцієнтів по модулю — неочевидна ідея, гарний приклад прихованої математики.                                                                              |
| **66**   | 🧮 **Найменші розв’язки діофантового рівняння**      | Пов'язана з рівняннями Пелля. Задача має багатий історичний бекграунд. Потребує знання продовжених дробів — глибоко теоретична.                                                                                      |
| **44**   | 💠 **Пентагональні числа**                           | Незвичайна властивість чисел — задача виглядає просто, але рішення потребує хитрої інверсії формули.                                                                                                                 |
| **87**   | 🧪 **Потужні прості суми**                           | Задача поєднує піднесення простих чисел до степенів 2, 3, 4 — створює цікаву динаміку комбінацій.                                                                                                                    |
| **179**  | 🧩 **Сусідні числа з однаковою кількістю дільників** | Досить рідкісна властивість, яку цікаво дослідити. Спонукає подумати над функцією `num_divisors` і її оптимізацією.                                                                                                  |
| **206**  | 🎯 **Приховане число з маскою**                      | Гра з цифрами — знайти число певного вигляду. Потребує розумного пошуку і відсіювання. Дуже “олімпіадна” по стилю.                                                                                                   |
